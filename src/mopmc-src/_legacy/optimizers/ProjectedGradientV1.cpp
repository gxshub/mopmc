...
namespace mopmc::optimization::optimizers {
    ...
    template<typename V>
    int ProjectedGradientV1<V>::minimize(Vector<V> &point,
    ...
    template<typename V>
    Vector<V> ProjectedGradientV1<V>::dykstrasProjection(const Vector<V> &point,
                                                       const std::vector<Vector<V>> &Vertices,
                                                       const std::vector<Vector<V>> &Directions,
    ...
    template<typename V>
    Vector<V> ProjectedGradientV1<V>::halfspaceProjection(const Vector<V> &point,
    ...
    template<typename V>
    Vector<V> ProjectedGradientV1<V>::findProjectedDescentDirection(const Vector<V> &point,
    ...
    template<typename V>
    bool ProjectedGradientV1<V>::checkNonExteriorPoint(Vector<V> &point,
                                                     const std::vector<Vector<V>> &Vertices,
                                                     const std::vector<Vector<V>> &Directions) {
    ...
    template<typename V>
    void ProjectedGradientV1<V>::exteriorProjectionPhase(){
        const V step = 0.0001;
        xCurrent = xNew;
    ...
    template class ProjectedGradientV1<double>;
}// namespace mopmc::optimization::optimizers