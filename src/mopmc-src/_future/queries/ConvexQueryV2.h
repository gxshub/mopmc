...
#ifndef MOPMC_CONVEXQUERYV2_H
#define MOPMC_CONVEXQUERYV2_H
...
namespace mopmc::queries {
    ...
    class ConvexQueryV2 : public BaseQuery<V, I> {
    public:
        ConvexQueryV2(const mopmc::QueryData<V, I> &data,
