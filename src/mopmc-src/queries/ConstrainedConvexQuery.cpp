...
namespace mopmc::queries {
    ...
    void ConstrainedConvexQuery<T, I>::query() {
        ...
        while (iter < maxIter) {
            ...
            this->innerOptimizer->minimize(direction, innerPoint, Vertices, outerPoint);
            ...
            if (iter >= 100 && std::max(epsilonInnerValueImpr, epsilonOuterValueImpr) < toleranceValueImpr) {
            ...
            if (iter >= 10 && epsilonSmallGradient < toleranceSmallGradient) {
